<template>
  <div id="app">
    ...
    <div v-if="!screen_phone" class="item">
      ...
      <mavon-editor ref="md" :subfield = "subfield" :toolbarsFlag = "toolbarsFlag" :toolbars="toolbars_large" :codeStyle="code_style" :language = "d_language" :ishljs="true" @change="change" @save="saveone" class="item-editor" v-model="help1"
      :external_link="external_link"></mavon-editor>
    </div>
    <div v-if="screen_phone" class="item">
      <h2 class="item-header">
